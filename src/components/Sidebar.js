  ...
  return (
    ...
    >
      ...
      <nav className="flex flex-col space-y-4">
        <SidebarLink to="/dashboard/home" title="Home" icon={<FaHome />} active={active} setActive={setActive} isExpanded={isExpanded} />
        <SidebarLink to="/dashboard/invoice" title="Invoice" icon={<FaFileInvoice />} active={active} setActive={setActive} isExpanded={isExpanded} />
        <SidebarLink to="/dashboard/product" title="Product" icon={<FaBox />} active={active} setActive={setActive} isExpanded={isExpanded} />
        <SidebarLink to="/dashboard/customer" title="Client" icon={<FaUserAlt />} active={active} setActive={setActive} isExpanded={isExpanded} />
        <SidebarLink to="/dashboard/expenses" title="Expenses" icon={<FaClipboardList />} active={active} setActive={setActive} isExpanded={isExpanded} className="mt-17" />
        <SidebarLink to="/dashboard/analytics" title="Analytics" icon={<AiOutlineBarChart />} active={active} setActive={setActive} isExpanded={isExpanded} />
        <SidebarLink to="/dashboard/reports" title="Reports" icon={<FaFileAlt />} active={active} setActive={setActive} isExpanded={isExpanded} />
      </nav>
    </div>
  );
};
